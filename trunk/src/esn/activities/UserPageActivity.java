...
public class UserPageActivity extends Activity implements OnNavigationListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		formatter = new SimpleDateFormat(
				getString(R.string.esn_global_dateFormat));
						...
						public void run() {
							...
							if (isonl == true) {
								txtstatus.setText(res
										.getString(R.string.esn_userpage_online));
							} else {
								txtstatus.setText(res
										.getString(R.string.esn_userpage_ofline));
							}

							String city = user.Address + " " + user.Street
							...
							if (gender == true) {
								txtgender.setText(res
										.getString(R.string.esn_userpage_Male));
							} else {
								txtgender.setText(res
										.getString(R.string.esn_userpage_Female));
							}
							...
							imageLoader.displayImage(user.Avatar, activity,
									avatar);
	...
	private void setupListNavigate() {
		...
		getActionBar().setTitle(
				getString(R.string.str_Friends_UserPage_Title));
	}
