...
public class ListViewEventHomeAdapter extends CustomListAdapter<Events> {
	...
	public ListViewEventHomeAdapter(Activity activity,
			ArrayList<Events> listEventHome) {
	...
	protected Object createHolder(View convertView) {
		...
		holder.eventName = (TextView) convertView
				.findViewById(R.id.esn_home_event_title);
		holder.description = (TextView) convertView
				.findViewById(R.id.esn_home_event_description);
		holder.date = (TextView) convertView
				.findViewById(R.id.esn_home_event_date);
		holder.image = (ImageView) convertView
				.findViewById(R.id.esn_home_event_listEventImage);
		return holder;
	}
	...
	protected void customRowView(Events rowBean, Object rowHolder) {
		...
		holder.eventName.setText(EventType.GetName(rowBean.EventTypeID,
				holder.eventName.getResources()));
